...
namespace Microsoft.CodeAnalysis.CSharp.CodeGen
{
    internal partial class CodeGenerator
    {
        ...
        private string GetLocalDebugName(ILocalSymbolInternal local, out LocalDebugId localId)
        {
            ...
            // only user-defined locals and @ should be named during lowering:
            Debug.Assert((local.Name == null) == (localKind != SynthesizedLocalKind.UserDefined && localKind != SynthesizedLocalKind.PipePlaceholder));
